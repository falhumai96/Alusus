...
class TargetTriplet(ExtendedEnum):
    ...
    X64_WINDOWS = _CombinedTargetTriplet(
        "x64-windows", "x64-windows-static-release", "win32", "AMD64", abi="msvc", cmake_generator=_prefer_ninja())
    X64_MINGW = _CombinedTargetTriplet(
        "x64-mingw", "x64-mingw-static-release", "win32", "AMD64", abi="gnu", cmake_generator=_prefer_ninja())
